...
%% State equations
    ...
    xtaodot = vao;
    vaodot = (1/mao)*(mao*g + rao*iao - ktao*xtao - kmao*xmao);
    vlvtdot = (1/mlvt)*(mlvt*g + rlv*ilv - kmlv*xmlv);
    xlvtdot = vlvtdot;    
    xmaodot = vao - vpao;
    xmlvdot = vlvt - vplv;    
    vpaodot = (1/mpao)*(Fmao - Rpao*vpao + mpao*g - Fdao);
    xpaodot = vpaodot;
    vplvdot = (1/mplv)*(Fmlv + mplv*g - Rplv*vplv - Fdlv);
    xplvdot = vplv;    
